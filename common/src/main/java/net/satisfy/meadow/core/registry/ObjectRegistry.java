...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Item> WOOLY_COW_SPAWN_EGG_ITEM = registerItem("wooly_cow_spawn_egg", () -> new ArchitecturySpawnEggItem(EntityTypeRegistry.SHEARABLE_MEADOW_VAR_COW, -1, -1, getSettings()));
