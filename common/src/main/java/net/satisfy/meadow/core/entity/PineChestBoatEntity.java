...
public class PineChestBoatEntity extends PineBoatEntity implements HasCustomInventoryScreen, ContainerEntity {
    ...
    public PineChestBoatEntity(EntityType<? extends Boat> entityType, Level level) {
